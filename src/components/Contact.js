...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.code == 200) {
      ...
      setStatus({ succes: false, message: 'Algo salió mal, intente más tarde.'});
    }
  };
              ...
              {({ isVisible }) =>
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" value={formDetails.phone} placeholder="N° Teléfono" onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
